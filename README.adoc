= griffon-ebean-plugin
:linkattrs:
:project-owner:   griffon
:project-repo:    griffon-plugins
:project-name:    griffon-ebean-plugin
...
The Ebean plugin enables lightweight access multiple datasources using link:https://github.com/ebean-orm/avaje-ebeanorm[Ebean ORM window="_blank"]
