...
----
dependencies {
    griffon '{project-group}:griffon-ebean-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-ebean-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-ebean-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-ebean-plugin` BOM in your POM file, by placing the following
